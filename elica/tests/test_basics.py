...
def test_check_equal_to_dict(data_dir):
    ...
    info = {
        "dataset_file": os.path.join(data_dir, "params.dataset"),
        "dictionary_file": (
            "/Users/valentinagenesini/Documents/thesis/ELICA/elica/data/mhl_dict.pickle"
        ),
    }

    likelihood = mHL(info)

    # necessario per il path nel metodo
    likelihood.dictionary_file = (
        "/Users/valentinagenesini/Documents/thesis/ELICA/elica/data/mhl_dict.pickle"
    )
