...
output_file = (
    "/Users/valentinagenesini/Documents/thesis"
    "/ELICA/elica/tests/.test/test_simple_sampling.1.txt"
)
output_file2 = (
    "/Users/valentinagenesini/Documents/thesis"
    "/ELICA/elica/tests/.test/test_simple_sampling10000sims.1.txt"
)
# param_names = [
#     "weight", "minuslogpost", "tau", "logA", "As",
#     "minuslogprior", "minuslogprior__0", "chi2",
#     "chi2__elica.EE_100x143",
# ]
param_names = ["tau"]
data = []
